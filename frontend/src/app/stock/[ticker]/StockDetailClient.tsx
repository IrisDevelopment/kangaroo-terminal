...
import { ArrowLeft, Loader2, ArrowDownRight, X, ExternalLink, BrainCircuit, Calculator, Star, ChevronDown, Layers, Plus, Search, Users, Briefcase, PieChart as PieIcon, Target, Info } from "lucide-react";
      ...
      <div className="mt-8">
                        ...
                        <div className="pt-8 border-t border-white/10">
                             <div className="flex justify-between items-center mb-6">
                                ...
                                <div className={`px-3 py-1 rounded text-xs font-bold uppercase tracking-wider ${
                                    valuation.targets.recommendation.toLowerCase().includes("buy") ? "bg-green-500/10 text-green-500" :
        ...
        {activeTab === "corporate" && (
          <div className="space-y-6">
             ...
             {/* dividend chart */}
             <div className="luxury-card p-8 rounded-xl min-h-75 flex flex-col">
                ...
                {institutional?.targets?.mean ? (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                        ...
                        <div className="text-center p-6 bg-white/5 rounded-xl border border-white/10">
                            ...
                            <h2 className={`text-3xl font-bold font-instrument ${
                                institutional.targets.recommendation.includes("Buy") ? "text-success" : 
